...
namespace alex2alan\admin\components;
 ...
 * 
 * ```
 * Yii::$container->set('alex2alan\admin\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
{
    const CACHE_TAG = 'alex2alan.admin';
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'alex2alan.admin.configs', []);
