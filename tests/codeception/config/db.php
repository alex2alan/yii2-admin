...
$databases = [
    'mysql' => [
        'dsn' => 'mysql:host=127.0.0.1;dbname=alex2alan_admin_test',
        'username' => 'travis',
        'password' => '',
    ],
    'sqlite' => [
        //'dsn' => 'sqlite::memory:',
        'dsn' => 'sqlite:@runtime/alex2alan_admin_test.sqlite',
    ],
    'pgsql' => [
        'dsn' => 'pgsql:host=localhost;dbname=alex2alan_admin_test;port=5432;',
        'username' => 'postgres',
        'password' => 'postgres',
    ],
];
