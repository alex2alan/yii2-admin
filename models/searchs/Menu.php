...
namespace alex2alan\admin\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use alex2alan\admin\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\alex2alan\admin\models\Menu]].
 * 
